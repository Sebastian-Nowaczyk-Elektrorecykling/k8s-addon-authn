...
bash scripts/initialize-secrets.sh --admin-email "$admin_email"
...
echo 'Provisioning ZITADEL and OIDC credentials. OAuth2 Proxy may remain pending until this completes.'
